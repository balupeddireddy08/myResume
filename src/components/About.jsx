    ...
    <section id="about" className="py-20 px-4 bg-gray-50 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      <div className="container mx-auto">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="relative w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-blue-400 dark:border-blue-500 shadow-xl">
            <img 
              src={profilePic} 
              alt="P.B.G.R." 
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <div className="flex items-center mb-6">
              <FaBriefcase className="text-3xl text-blue-400 mr-4" />
            ...
            <div className="space-y-8">
              <div className="border-l-2 border-blue-400 pl-4">
                ...
                <p className="text-blue-400">BMW Financial Services NA, LLC</p>
              ...
              <div className="border-l-2 border-blue-400 pl-4">
                ...
                <p className="text-blue-400">Tata Consultancy Services Ltd</p>
          ...
          >
            <div className="flex items-center mb-6">
              <FaGraduationCap className="text-3xl text-purple-400 mr-4" />
            ...
            <div className="space-y-8">
              <div className="border-l-2 border-purple-400 pl-4">
                ...
                <p className="text-purple-400">University of Cincinnati</p>
              ...
              <div className="border-l-2 border-purple-400 pl-4">
                ...
                <p className="text-purple-400">VNR Vignana Jyothi Institute of Technology</p>
        ...
        <div className="flex justify-center mt-12">
          <motion.a
            ...
            className="flex items-center bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-3 px-8 rounded-full"
